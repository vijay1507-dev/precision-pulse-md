...
class UpdateDoctorRequest extends FormRequest
{
    ...
    protected function basicInfoRules($doctor = null): array
    {
        return [
    ...
    protected function basicInfoMessages(): array
    {
        return [
            ...
            'profile_photo.mimes'   => 'Profile photo must be in JPG, JPEG, PNG, GIF, or WebP format.',
            'profile_photo.max'     => 'Profile photo size must be under 2MB.',
        ];
    }

    protected function specializationMessages(): array
    {
        return [
    ...
    protected function experienceMessages(): array
    {
        return [
    ...
    protected function availabilityMessages(): array
    {
        return [
