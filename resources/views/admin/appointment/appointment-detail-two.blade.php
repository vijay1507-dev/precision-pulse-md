       ...
       <div class="row">
          <div class="col-12 col-md-4 col-sm-6 mb-4 pb-3">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <img src="../adminpanel/image/user.png" class="avatar img-fluid  " alt="">
           ...
           <div class="col-12 col-md-4 col-sm-6 mb-4 pb-3">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <img src="../adminpanel/image/phone.png" class="avatar img-fluid  " alt="">
              <div class="d-grid ms-3 text-start">
           ...
           <div class="col-12 col-md-4 col-sm-6 mb-4 pb-3">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <img src="../adminpanel/image/date.png" class="avatar img-fluid  " alt="">
              <div class="d-grid ms-3 text-start">
           ...
           <div class="col-12 col-md-4 col-sm-6 mb-4 pb-3">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <img src="../adminpanel/image/check.png" class="avatar img-fluid  " alt="">
              <div class="d-grid ms-3 text-start">
           ...
           <div class="col-12 col-md-4 col-sm-6 mb-4 pb-3">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <img src="../adminpanel/image/doctor.png" class="avatar img-fluid  " alt="">
              <div class="d-grid ms-3 text-start">
           ...
           <div class="col-12 col-md-4 col-sm-6 mb-0 pb-0">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <img src="../adminpanel/image/price.png" class="avatar img-fluid  " alt="">
              <div class="d-grid ms-3 text-start">
...
<div class="mt-4">
   <h3 class="mb-3">Attached File</h3>
    ...
    <div class="row">
      <div class="col-12 col-md-4 col-sm-6 mb-0 pb-0">
        <div class="nav-icon pe-md-0 d-flex align-items-center">
          <img src="../adminpanel/image/pdf.png" class="avatar img-fluid  " alt="">
          <div class="d-grid ms-3 text-start">
...
<div class="mt-4">
    <h3 class="mb-3">Prescription Details</h3>
    ...
    <div class="card custom-card main-card-item primary border-0 p-4 rounded-30">
       <div class="row">
          <div class="col-12 col-md-4 col-sm-6 mb-4 pb-3">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <div class="d-grid ms-3 text-start">
                <span class="text-dark mb-1 fs-medium h6">Prescription ID</span>
          ...
          <div class="col-12 col-md-4 col-sm-6 mb-4 pb-3">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <div class="d-grid ms-3 text-start">
                <span class="text-dark mb-1 fs-medium h6">Prescribed By</span>
                <span class="text-dark">Dr. Sarah Johnson</span>
              </div>
            </div>
          </div>
           <div class="col-12 col-md-4 col-sm-6 mb-4 pb-3">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <div class="d-grid ms-3 text-start">
                <span class="text-dark mb-1 fs-medium h6">Issue Date</span>
                <span class="text-dark">2025-07-15</span>
              </div>
            </div>
          </div>
           <div class="col-12 col-md-4 col-sm-6 mb-0 pb-0">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <div class="d-grid ms-3 text-start">
                <span class="text-dark mb-1 fs-medium h6">Expiry Date</span>
                <span class="text-dark">2025-10-15</span>
              </div>
            </div>
          </div>
           <div class="col-12 col-md-4 col-sm-6 mb-0 pb-0">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <div class="d-grid ms-3 text-start">
                <span class="text-dark mb-1 fs-medium h6">Diagnosis</span>
                <span class="text-dark">Hypertension, Type 2 Diabetes</span>
              </div>
            </div>
          </div>
           <div class="col-12 col-md-4 col-sm-6 mb-0 pb-0">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <div class="d-grid ms-3 text-start">
                <span class="text-dark mb-1 fs-medium h6">Refills Remaining</span>
...
<div class="mt-4">
    ...
    <div class="card custom-card main-card-item primary border-0 p-4 rounded-30">
       <div class="row">
          <div class="col-12 col-md-4 col-sm-6 mb-4 pb-3">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <div class="d-grid ms-3 text-start">
                <span class="text-dark mb-1 fs-medium h6">Medication</span>
                <span class="text-dark">Lisinopril</span>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-4 col-sm-6 mb-4 pb-3">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <div class="d-grid ms-3 text-start">
                <span class="text-dark mb-1 fs-medium h6">Dosage</span>
                <span class="text-dark">10mg</span>
              </div>
            </div>
          </div>
           <div class="col-12 col-md-4 col-sm-6 mb-4 pb-3">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <div class="d-grid ms-3 text-start">
                <span class="text-dark mb-1 fs-medium h6">Frequency</span>
                <span class="text-dark">Once daily</span>
              </div>
            </div>
          </div>
           <div class="col-12 col-md-4 col-sm-6 mb-0 pb-0">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <div class="d-grid ms-3 text-start">
                <span class="text-dark mb-1 fs-medium h6">Duration</span>
                <span class="text-dark">3 months</span>
              </div>
            </div>
          </div>
           <div class="col-12 col-md-4 col-sm-6 mb-0 pb-0">
            <div class="nav-icon pe-md-0 d-flex align-items-center">
              <div class="d-grid ms-3 text-start">
                <span class="text-dark mb-1 fs-medium h6">Notes</span>
                <span class="text-dark">Take with food</span>
              </div>
            </div>
          </div>
 ...
 <div class="text-center mt-4">
        <a class="btn btn-primary rounded-30" href="edit-prescription.html">Edit Prescription</a>
    </div>
</div>
</div>
</x-admin-layout>
